import { variantGetParameter, variantGetBracket, getBracket, hasThemeFn, transformThemeFn, getStringComponent } from '@unocss/rule-utils';
import { h, r as resolveBreakpoints, C as CONTROL_MINI_NO_NEGATIVE, q as cssMathFnRE, u as cssVarFnRE } from './shared/unocss-preset-weapp.d4ee9f3f.mjs';
import { variantMatcher, variantParentMatcher } from './utils.mjs';
