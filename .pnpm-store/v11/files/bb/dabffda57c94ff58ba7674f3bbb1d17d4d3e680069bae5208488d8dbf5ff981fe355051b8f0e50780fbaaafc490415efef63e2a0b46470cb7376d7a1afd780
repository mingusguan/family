...
export { t as theme } from './shared/unocss-preset-weapp.e3e6056e.js';
import { T as Theme } from './shared/unocss-preset-weapp.d9544800.js';
export { C as Colors, a as ThemeAnimation } from './shared/unocss-preset-weapp.d9544800.js';
import '@unocss/core';
