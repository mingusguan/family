...
export { t as theme } from './shared/unocss-preset-weapp.ff7b1ae5.cjs';
import { T as Theme } from './shared/unocss-preset-weapp.d9544800.cjs';
export { C as Colors, a as ThemeAnimation } from './shared/unocss-preset-weapp.d9544800.cjs';
import '@unocss/core';
