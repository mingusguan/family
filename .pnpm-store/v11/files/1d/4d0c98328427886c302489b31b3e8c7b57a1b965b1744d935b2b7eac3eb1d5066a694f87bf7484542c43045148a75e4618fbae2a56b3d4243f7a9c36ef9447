...
export { C as CONTROL_MINI_NO_NEGATIVE, c as colorResolver, a as colorableShadows, d as directionSize, h as hasParseableColor, i as isCSSMathFn, e as isSize, m as makeGlobalStaticRules, p as parseColor, r as resolveBreakpoints, b as resolveVerticalBreakpoints, s as splitShorthand, t as transformXYZ } from './shared/unocss-preset-weapp.1a732bbf.cjs';
import { VariantHandlerContext, VariantObject } from '@unocss/core';
import './shared/unocss-preset-weapp.d9544800.cjs';
