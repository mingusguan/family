  ...
  <view class="page">
    ...
    <view class="profile-card">
      ...
      <view class="avatar-picker" @click="chooseAvatar">
        <image v-if="profileForm.avatar" :src="profileForm.avatar" class="avatar" mode="aspectFill" />
...
const profileForm = reactive<UserProfileForm>({ nickname: "", avatar: "" });
...
const chooseAvatar = () => {
  ...
  uni.chooseMedia({
    ...
    success: (res) => uploadAvatar(res.tempFiles[0].tempFilePath),
  });
  // #endif
...
const handleComplete = async () => {
  ...
  try {
    ...
    await UserAPI.updateProfile({ nickname, avatar: profileForm.avatar });
